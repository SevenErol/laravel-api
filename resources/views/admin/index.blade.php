        ...
        <table class="table p-5">
            <thead>
                <div class="row justify-content-between p-3 bg-light m-0 border-bottom border-dark align-items-center">
                    ...
                    <div class="col-2 text-end"><a href="{{ route('admin.project.create') }}" type="button"
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex flex-column">
                                <div>
                                    <a href="{{ route('admin.project.show', $project->id) }}" type="button"
                                        class="btn btn-secondary col-12 mb-3">View</a>
                                </div>
                                <div>
                                    <a href="{{ route('admin.project.edit', $project->id) }}" type="button"
